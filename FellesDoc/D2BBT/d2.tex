...
%TCIDATA{LastRevised=Monday, March 19, 2012 13:03:56}
...
Login dialogue: \newline \includegraphics[scale=0.5]{Login.png}\newline
The calendar view: \newline \includegraphics[scale=0.5]{Kalender.png}\newline
Calendar selection: \newline \includegraphics[scale=0.5]{kalendere.png}\newline
User selection: \newline \includegraphics[scale=0.5]{brukere.png}\newline
Appointment edit-dialogue: \newline \includegraphics[scale=0.5]{Avtale.png}\newline
Datepick dialogue: \newline \includegraphics[scale=0.5]{datepicker.png}\newline
Meeting invitation dialogue: \newline \includegraphics[scale=0.5]{moteinvite.png}%
\newline
Create-a-meeting dialogue: \newline \includegraphics[scale=0.5]{mote.png}\newline
Meeting room booking dialogue: \newline \includegraphics[scale=0.5]{moterom.png}%
\newline
\newpage
\part{Testing}
...
Create-a-meeting dialogue: \newline \includegraphics[scale=0.5]{mote2.png}\newline
